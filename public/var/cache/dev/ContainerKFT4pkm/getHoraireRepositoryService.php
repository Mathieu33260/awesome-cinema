...
// Returns the private 'App\Repository\HoraireRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/HoraireRepository.php';

return $this->privates['App\Repository\HoraireRepository'] = new \App\Repository\HoraireRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
